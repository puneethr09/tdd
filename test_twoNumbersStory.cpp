...
TEST(TwoNumbersStorySuite, division){
    ...
    EXPECT_EQ(num.quotient(), 4.0F);
}

TEST(TwoNumbersStorySuite, quotientExceeds20){
    TwoNumbersStory num(25,1);
    EXPECT_THROW(num.quotient(), std::invalid_argument);
}
